        ...
        if (tafjRuntimeConfiguration == null) {
            ...
            */
            ...
            try {
            	...
            	// Dinesh fix for remote access to EJB 
            	instance.tafjRuntimeConfiguration = T24RuntimeConfigurationFactory.buildRuntimeConfiguration(RuntimeType.TAFJ,jbossProperties, authenticationProperties, false);
