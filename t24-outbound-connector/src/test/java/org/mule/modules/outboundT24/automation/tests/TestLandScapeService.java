...
import com.temenos.adapter.mule.T24outbound.definition.GetComposerLandscapeResponse2;
...
public class TestLandScapeService {
	...
	public static void main(String args[]) throws ConnectionException, T24MetadataException{
		...
		config.testConnect("INPUTT", "http://localhost:9089/axis2/services/IntegrationLandscapeServiceWS?wsdl", "D:/Schemas/UserCredentials.txt");
		
		TestLandScapeService test = new TestLandScapeService(config);
		
		test.config.connect("INPUTT", config.getServiseURL(), "D:/Schemas/UserCredentials.txt");
