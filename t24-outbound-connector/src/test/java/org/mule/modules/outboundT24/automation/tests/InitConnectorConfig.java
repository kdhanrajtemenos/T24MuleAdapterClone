...
import com.temenos.adapter.oracle.util.PasswdUtil;
...
public class InitConnectorConfig {
	...
	private static final String SERVICE_XML_SCHEMA_DIR = IoResourseUtil.SHEMA_DIR_KEY;
	...
	public ConnectorConfig getConfigFromFile(String configfile) throws ConnectionException {
		...
		config.setAgentUser(_agentUser);
		//config.setAgentPass(_agentPass);
		config.setFolder(_directory);
		...
		config.connect(username,/* password,*/ wsdllocation, _directory);
