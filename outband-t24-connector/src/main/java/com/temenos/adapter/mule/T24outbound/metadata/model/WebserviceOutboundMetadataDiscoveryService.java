...
import org.mule.modules.outbandt24.definition.GetComposerLandscapeResponse2;

import org.mule.modules.outbandt24.definition.IntegrationLandscapeServiceWSPortType;
import org.mule.modules.outbandt24.definition.ObjectFactory;
import org.mule.modules.outbandt24.definition.ResponseDetails;
import org.mule.modules.outbandt24.definition.Schema;
import org.mule.modules.outbandt24.definition.T24UserDetails;
...
public class WebserviceOutboundMetadataDiscoveryService implements OutboundMetadataDiscoveryService
{
	  ...
	  public MetadataTree getMetadataTree(IntegrationLandscapeServiceWSclient proxyClient) throws T24MetadataException
	  {
		   ...
		   GetComposerLandscapeResponse2 response = service.getComposerLandscape(userDetails);
